...
iperf_tcp_listen(struct iperf_test *test)
{
	...
	// Not such a big deal, Windows does not support TCP_MAXSEG anyway
	// https://support.microsoft.com/en-us/kb/224829 might contain information
	// about how to change MSS
